// COPILOT: React version of Django templates/about.html rendered inside Django base.html body markup.
...
const About = () => {
  const renderedHtml = useMemo(() => injectContent(baseTemplate, aboutTemplate), []);

  useEffect(() => {
    // Set page title
    document.title = 'About - Yale It Skill Hub Training Institute in Coimbatore';
